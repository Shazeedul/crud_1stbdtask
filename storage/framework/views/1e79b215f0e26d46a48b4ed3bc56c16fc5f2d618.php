...
<div class="card">
  ...
  <div class="card-body">
    <div class="pull-right">
      <a class="btn btn-primary btn-sm" href="<?php echo e(route('comments.index')); ?>" title="Go back"> <i class="fas fa-backward "></i>Go Back </a>
    </div>
    <br>
...
<?php echo $__env->make('layouts.comment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\admin\Documents\crud-app\resources\views/comments/create.blade.php ENDPATH**/ ?>